...
export const load = async ({ params, cookies }) => {
	...
	return { conference, ticketTypes, contactInfo, pageContent: conference.supportingPages.kidsActivities, pageTitle: 'Kids Activities', supportingPages, isAuthenticated };
};
