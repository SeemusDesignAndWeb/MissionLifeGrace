...
export const load = async ({ params, cookies }) => {
	...
	if (!conference.supportingPages?.worshipAndMinistry) {
	...
	return { conference, ticketTypes, contactInfo, pageContent: conference.supportingPages.worshipAndMinistry, pageTitle: 'Worship and Ministry', supportingPages, isAuthenticated };
};
