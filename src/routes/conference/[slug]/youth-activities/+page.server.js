...
export const load = async ({ params, cookies }) => {
	...
	if (!conference.supportingPages?.youthActivities) {
	...
	return { conference, ticketTypes, contactInfo, pageContent: conference.supportingPages.youthActivities, pageTitle: 'Youth Activities', supportingPages, isAuthenticated };
};
