...
export const load = async ({ params, cookies }) => {
	...
	if (!conference.supportingPages?.whatYouNeed) {
	...
	return { conference, ticketTypes, contactInfo, pageContent: conference.supportingPages.whatYouNeed, pageTitle: 'What You Need', supportingPages, isAuthenticated };
};
